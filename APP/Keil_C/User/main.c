...
extern void sysRest(void);
extern void CMP_Init(void);
extern void DevicePowerOnInit(void);
extern void sysRuning(void);

unsigned long int exKeyValueFlag =0;
    ...
    while(1)
    {
        ...
        if(SOCAPI_TouchKeyStatus & 0x80)
        {
            ...
            { 
								...
								if(exKeyValueFlag == 0x4002ul)
                {
										KeyCancelRestFlag =1;
										NoKeyPressFalg = 0;
                }
                
                else if(exKeyValueFlag&0x02ul)
                {
                    KeyRestFlag = 1;
										NoKeyPressFalg = 0;
                }
