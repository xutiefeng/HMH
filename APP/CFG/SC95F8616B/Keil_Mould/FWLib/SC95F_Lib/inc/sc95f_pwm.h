...
typedef enum
{
  ...
  PWM2_PRESSEL_FSYS_D1 = (uint8_t)0x02, //PWM2预分频为Fsys/1
  PWM3_PRESSEL_FSYS_D1 = (uint8_t)0x03, //PWM3预分频为Fsys/1
  PWM4_PRESSEL_FSYS_D1 = (uint8_t)0x04, //PWM4预分频为Fsys/1
} PWM_PresSel_TypeDef;
#else
//PWM预分频选择
typedef enum
...
#if defined(SC95FWxx) || defined(SC95F8x3x) || defined(SC95F7x3x) || defined (SC95F8x6x) || defined (SC95F7x6x)\
		|| defined (SC95F8x1xB) || defined (SC95F7x1xB) || defined (SC95R751) || defined (SC95F7610B) || defined (SC95F7619B)\
		|| defined (SC95R602)  || defined (SC95R605) || defined (SC95F8x7x) || defined (SC95F7x7x)|| defined(SC95R503)
//SC95FWxx SC95F8x3x SC95FWxx 函数声明
...
void PWM_FaultDetectionModeConfig(PWM_FaultDetectionMode_TypeDef FaultDetectionMode,
                                  PWM_FaultDetectionVoltageSelect_TypeDef FaultDetectionVoltageSelect,
                                  PWM_FaultDetectionWaveFilteringTime_TypeDef FaultDetectionWaveFilteringTime);
ErrorStatus PWM_IndependentMode_DutyChange(PWM_OutputPin_TypeDef PWM_OutputPin, PWM_DutyChange_TypeDef Change_Direction, uint16_t DutyIncremental);
