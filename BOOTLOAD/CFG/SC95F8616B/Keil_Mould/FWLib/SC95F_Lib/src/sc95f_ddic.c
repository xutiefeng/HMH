...
#include "sc95f_ddic.h"
		...
		|| defined (SC95F8x1xB) || defined (SC95F7x1xB) || defined (SC95R751) || defined (SC95F7610B) || defined (SC95R602)  || defined (SC95R605)
...
uint8_t xdata LCDRAM[30] _at_ 0x1000;
			...
			|| defined (SC95R751)	|| defined (SC95F7610B) || defined (SC95R602) || defined (SC95R605)
