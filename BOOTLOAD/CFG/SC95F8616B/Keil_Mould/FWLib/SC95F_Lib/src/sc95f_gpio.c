...
void GPIO_DeInit(void)
{
		...
		|| defined (SC95F7610B)	|| defined (SC95R602) || defined (SC95R605)
  P0CON = 0x00;
  P1CON = 0x00;
  P2CON = 0x00;
  P3CON = 0x00;
...
#if defined(SC95F8x2x) || defined(SC95F7x2x) || defined(SC95FS52x) || defined(SC95F8x7x) || defined(SC95F7x7x)|| defined(SC95R503)
  P0CON = 0x00;
  P1CON = 0x00;
  P2CON = 0x00;
  P5CON = 0x00;
...
BitStatus:返回Pxy的值
**************************************************/
BitStatus GPIO_ReadPin(GPIO_TypeDef GPIOx, GPIO_Pin_TypeDef PortPins)
{
