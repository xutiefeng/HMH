...
typedef enum
{
  ...
  IAP_OPERATERANGE__ALL_CODEREGION = (uint8_t)0x0c      //允许ROM所有区域进行IAP操作
		...
		|| defined (SC95F8x1xB) || defined (SC95F7x1xB) || defined (SC95R751) || defined (SC95F7610B) || defined (SC95F7619B) || defined(SC95FS52x)\
...
typedef enum
{
  ...
  IAP_OPERATERANGE__ALL_CODEREGION = (uint8_t)0x0c      //允许ROM所有区域进行IAP操作
		...
		|| defined (SC95F7610B) || defined (SC95F7619B) || defined (SC95R602)  || defined (SC95R605) || defined(SC95F8x7x) || defined(SC95F7x7x)\
    || defined(SC95R503)
/* ADC参考电压挡位枚举 */
typedef enum
{
...
#if defined(SC95F8x1x) || defined(SC95F7x1x) || defined(SC95FWxx) ||  defined(SC95F8x2x) || defined(SC95F7x2x) || defined(SC95FS52x)\
